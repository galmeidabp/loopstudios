      ...
      <div className="max-w-[272px] m-auto py-10 flex flex-col items-center lg:max-w-5xl lg:flex-row lg:justify-between lg:items-start">
        ...
        <div className="mt-14 flex flex-col items-center lg:mt-0 lg:items-end">
          <div className="flex gap-5">
            <a href="#" aria-label="Go to Facebook" className="hover:text-gray-300"><Facebook /></a>
            <a href="#" aria-label="Go to Twitter" className="hover:text-gray-300"><Twitter /></a>
            <a href="#" aria-label="Go to Instagram" className="hover:text-gray-300"><Instagram /></a>
          </div>
